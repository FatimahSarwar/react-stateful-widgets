...
export default function Moods() {
  ...
  return (
    <div className='widget-moods container'>
      ...
      <div>
        <button id='makeHappy' onClick={makeHappy}mood = {happyMood}>Make Happy</button>
        <button id='makeSad' onClick={makeSad}mood ={sadMood}>Make Sad</button>
        <button id='resetMood' onClick={reset} mood = {initialMood}>Reset</button>
      </div>
    </div>
  );
}
